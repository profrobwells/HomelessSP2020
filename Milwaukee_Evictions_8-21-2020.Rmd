...
```{r}
milw <- rio::import("https://raw.githubusercontent.com/Howard-Center-Investigations/evictions/master/cleaning/output/wi_milwaukee/sta_wi_milwaukee_2019_2020.csv?token=AK7LSTHWMKQIABQRMAYJ64C7JE5YO") 
```
...
- **Context**: During the entire course of this study, the 19,420 eviction records since January 2019, the average number of evictions by a landlord was 3. 
```{r}
summary(plaintiff1)
```
...
- **Context**: Berrada properties and its 18 affiliates were responsible for 2,230 eviction filings in Milwaukee City and County, or at least 11% of all 19,420 eviction filings since January 2019. Anchor Properties and its affiliates accounted for 3% of filings.
